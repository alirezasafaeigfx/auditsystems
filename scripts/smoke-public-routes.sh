...
check "/qualification" "200" "Qualification page (FA)"
check "/en/qualification" "200" "Qualification page (EN)"
check "/asdev" "200" "ASDEV brand page"
check "/sample-report" "200" "Sample report (FA)"
