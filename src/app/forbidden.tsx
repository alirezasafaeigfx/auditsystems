  ...
  return (
    <main style={{ textAlign: "center", padding: "4rem 2rem" }}>
      ...
      <div style={{ display: "flex", gap: "1rem", justifyContent: "center" }}>
        <Link href="/login" style={{ padding: "0.75rem 1.5rem", background: "var(--brand)", color: "#fff", borderRadius: "0.5rem", textDecoration: "none", fontWeight: 600 }}>
          ورود
        </Link>
        <Link href="/" style={{ padding: "0.75rem 1.5rem", border: "1px solid var(--line)", borderRadius: "0.5rem", textDecoration: "none", fontWeight: 600 }}>
          صفحه اصلی
        </Link>
      </div>
    </main>
